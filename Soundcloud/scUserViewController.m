...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell.reuseIdentifier isEqualToString:@"AudioCell"])
    {
    ...
    } else if ([cell.reuseIdentifier isEqualToString:@"UserCell"]) {
        // Load the user image
        NSURL *UserImageUrl = [NSURL URLWithString:[user valueForKey:@"avatar_url"]];
        NSData *data = [NSData dataWithContentsOfURL:UserImageUrl];
        ...
        // Username
        [[(scUserCell *)cell userName] setText:[user valueForKey:@"username"]];
        
        // User details
        NSString *userDetails = @"";
        if ([user valueForKey:@"city"])
            userDetails = [userDetails stringByAppendingFormat:@"%@, ", [user valueForKey:@"city"]];
        if ([user valueForKey:@"country"])
            userDetails = [userDetails stringByAppendingFormat:@"%@\n", [user valueForKey:@"country"]];
        if ([user valueForKey:@"followers_count"])
            userDetails = [userDetails stringByAppendingFormat:@"Followers: %@", [user valueForKey:@"followers_count"]];
        if ([user valueForKey:@"followings_count"])
            userDetails = [userDetails stringByAppendingFormat:@" Following: %@", [user valueForKey:@"followings_count"]];
        if ([user valueForKey:@"track_count"])
            userDetails = [userDetails stringByAppendingFormat:@" Tracks: %@", [user valueForKey:@"track_count"]];
